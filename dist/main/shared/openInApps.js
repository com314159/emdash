...
exports.OPEN_IN_APPS = void 0;
exports.getAppById = getAppById;
exports.isValidOpenInAppId = isValidOpenInAppId;
exports.getResolvedLabel = getResolvedLabel;
exports.getResolvedIconPath = getResolvedIconPath;
const ICON_PATHS = {
    finder: 'finder.png',
...
function getAppById(id) {
    return exports.OPEN_IN_APPS.find((app) => app.id === id);
}
function isValidOpenInAppId(value) {
    return typeof value === 'string' && exports.OPEN_IN_APPS.some((app) => app.id === value);
}
function getResolvedLabel(app, platform) {
    return app.platforms[platform]?.label || app.label;
}
function getResolvedIconPath(app, platform) {
