...
exports.catalogData = {
    ...
    atlassian: {
        ...
        docsUrl: 'https://community.atlassian.com/forums/Atlassian-Platform-articles/Using-the-Atlassian-Remote-MCP-Server-beta/ba-p/3005104',
        credentialKeys: [],
    },
    notion: {
        config: {
    ...
    aws_marketplace: {
        ...
        docsUrl: 'https://docs.aws.amazon.com/marketplace/latest/APIReference/marketplace-mcp-server.html',
        credentialKeys: [],
    },
    motherduck: {
        config: {
